...
def naive_bayes(tsize0,tsize1):
    ...
    print("accuracy is {},error rate is {},recall is {} and precision is {}".format(accuracy,error_rate,recall,precision))                                                            #uncomment this for confusion matrix
...
def main():
    ...
    # plotter=[accuracy1,accuracy2,accuracy3,accuracy4,accuracy5,accuracy6]             # uncomment this to get accuracy for different training sizes
